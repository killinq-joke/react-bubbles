...
a token is a string that is used to authenticate if it exists in localStorage

- [x] What steps can you take in your web apps to keep your data secure?

make private routes, check for token, 

- [x] Describe how web servers work.

web servers are ran so that when we call them, they give us back info if we give them what they want.
It can then store reusable data.
